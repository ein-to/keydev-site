...
def message_text(name, email, phone, message):  # Текст сообщения для отправки на почту
    text = 'Уважаемый %s!<br> Мы получили сообщение от %s<br> со следующим текстом: <br> "%s"<br> ' \
           'Спасибо большое за обращение! Мы обязательно свяжемся с Вами через почту или перезвоним по номеру %s<br>' % (
